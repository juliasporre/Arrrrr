...
public class NetworkEntityState : NetworkBehaviour
{
    ...
    public override void OnStartClient()
    {
        ...
        var clientDreadnought = Instantiate<GameObject>(globals.Dreadnought);
        var clientScavenger = Instantiate<GameObject>(globals.Scavenger);

        ConfigureClientPrefab(clientDreadnought);
